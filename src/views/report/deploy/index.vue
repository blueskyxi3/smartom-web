    ...
    <div class="head-container">
      ...
      >
        ...
        >
          ...
          <el-form-item v-if="form.type == 1" label="content" prop="content">
            <el-input :rows="3" v-model="form.content" type="textarea" style="width: 370px;" />
          </el-form-item>
          <el-form-item v-if="form.type == 1" label="数据库" prop="dbId">
          ...
          <el-form-item v-if="form.type == 1" label="消息模板">
            <el-select
              v-model="form.msgId"
              filterable
              remote
      ...
      >
        ...
        <el-table-column v-if="columns.visible('name')" label="Name" prop="name">
          <template slot-scope="scope">
            <span v-if="scope.row.type ==0 ">{{scope.row.name}}</span>
            <el-button v-else size="mini" style="margin-right: 2px" type="text">
        ...
        <el-table-column v-if="columns.visible('msgId')" prop="msgId" label="消息模板ID" >
          <template slot-scope="scope">
            {{ scope.row.msgId }}
          </template>
        </el-table-column>
        <el-table-column v-if="columns.visible('createdBy')" prop="createdBy" label="createdBy" />
